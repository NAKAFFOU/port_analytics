...
def render(data, context):
    ...
    # KPI cards, each with a sparkline of the last 12 periods (see
    # viz_theme.py — a sparkline is a trend, not a comparison, so a line
    # is the appropriate form here).
    ...
    # Category share (donut — a "share of the whole" question) and
    # top-10 services (horizontal bars — a ranking question). See
    # viz_theme.py for why these two forms and not one chart type.
    category = (
